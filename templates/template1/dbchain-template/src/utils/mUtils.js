 ...
 * @returns
 */
export const jsonToSort = (json, key) => {
...
export function ToSize(val) {
  ...
  try {
    if (
      Math.floor(val / 1024 / 1024 / 1024 / 1024) >= 1 &&
      Number.isInteger(val / 1024 / 1024 / 1024 / 1024)
    ) {
      return [val / 1024 / 1024 / 1024 / 1024, "TB"];
    }
    if (
      Math.floor(val / 1024 / 1024 / 1024) >= 1 &&
      Number.isInteger(val / 1024 / 1024 / 1024)
    ) {
      return [val / 1024 / 1024 / 1024, "GB"];
    }
    if (
      Math.floor(val / 1024 / 1024) >= 1 &&
      Number.isInteger(val / 1024 / 1024)
    ) {
      return [val / 1024 / 1024, "MB"];
    }
    if (Math.floor(val / 1024) >= 1 && Number.isInteger(val / 1024)) {
      return [val / 1024, "KB"];
    }
  } catch (error) {
    return [val, "KB"];
